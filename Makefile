.PHONY: build up down logs migrate migrations check test lint shell superuser prepare-map sync-cnae sync-population
...
sync-population:
	docker compose run --rm web python manage.py sync_ibge_population
